...
public class GalleryActivity extends BaseActivity<GalleryViewModel, ActivityGalleryBinding> {
    ...
    private final Runnable mHidePart2Runnable = () -> {
        ...
        dataBinding.viewPager.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LOW_PROFILE
    ...
    private final Runnable mShowPart2Runnable = () -> {
        ...
        dataBinding.fullscreenContentControls.setVisibility(View.VISIBLE);
    };
    ...
    private void hide() {
        ...
        dataBinding.fullscreenContentControls.setVisibility(View.GONE);
        mVisible = false;
    ...
    private void show() {
        // Show the system bar
        dataBinding.viewPager.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
        mVisible = true;
