...
public class ChatAdapter extends BaseAdapter<Object, BaseViewHolder, ViewDataBinding> {

    public final SingleLiveEvent<Object> longClickEvent = new SingleLiveEvent<>();
    ...
    public int getLayoutId(int viewType) {
        switch (viewType) {
            case START_SIMPLE_VIEW_TYPE:
                return R.layout.item_chat_start_simple;
            case END_SIMPLE_VIEW_TYPE:
                return R.layout.item_chat_end_simple;
            case START_MEDIA_VIEW_TYPE:
                return R.layout.item_chat_start_media;
            case END_MEDIA_VIEW_TYPE:
                return R.layout.item_chat_end_media;
            case START_MAP_VIEW_TYPE:
                return R.layout.item_chat_start_map;
            case END_MAP_VIEW_TYPE:
                return R.layout.item_chat_end_media;
            case START_LINK_VIEW_TYPE:
                return R.layout.item_chat_start_link;
            case END_LINK_VIEW_TYPE:
                return R.layout.item_chat_end_link;
            case START_CALL_VIEW_TYPE:
                return R.layout.item_chat_start_call;
            case END_CALL_VIEW_TYPE:
                return R.layout.item_chat_end_call;
            case START_AUDIO_VIEW_TYPE:
                return R.layout.item_chat_start_audio;
            case END_AUDIO_VIEW_TYPE:
                return R.layout.item_chat_end_audio;
            case DATE_VIEW_TYPE:
            default:
    ...
    public BaseViewHolder onCreateViewHolderBinding(ViewDataBinding viewDataBinding, int viewType) {
        switch (viewType) {
            ...
            default:
                ChatViewHolder chatViewHolder = new ChatViewHolder(viewDataBinding);
